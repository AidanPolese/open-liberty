...
public class Headers {
    ...
    private static final TraceComponent tc = Tr.register(Headers.class);
    ...
    void removeContentType() {
        // Liberty change - removing unnecessary containsKey check
        headers.remove(PROTOCOL_HEADERS_CONTENT_TYPE);
    }

    public String getAuthorization() {
        // Liberty change - removed unnecessary containsKey check
