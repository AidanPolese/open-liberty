 ...
 */
public class ThreadLocalProxyCopyOnWriteArraySet<E> extends AbstractSet<E> {
    private static final long serialVersionUID = 5457747651344034263L;

    private final ThreadLocalProxyCopyOnWriteArrayList<E> al;

    /**
     * Creates an empty set.
     */
    public ThreadLocalProxyCopyOnWriteArraySet() {
        al = new ThreadLocalProxyCopyOnWriteArrayList<E>();
    }
     ...
     */
    public ThreadLocalProxyCopyOnWriteArraySet(Collection<? extends E> c) {
        al = new ThreadLocalProxyCopyOnWriteArrayList<E>();
        al.addAllAbsent(c);
    }
