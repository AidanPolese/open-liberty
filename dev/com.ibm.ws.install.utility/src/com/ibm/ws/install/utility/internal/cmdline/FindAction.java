...
public class FindAction implements ActionHandler {
    ...
    private boolean match(RepositoryResource mr) {
        ...
        if (searchDescription(mr.getDescription()))
            return true;
        String description = mr instanceof EsaResource ? ((EsaResource) mr).getShortDescription() :
                        mr instanceof SampleResource ? ((SampleResource) mr).getShortDescription() : null;
