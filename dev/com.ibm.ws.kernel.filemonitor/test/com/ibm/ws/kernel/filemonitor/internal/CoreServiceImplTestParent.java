...
public abstract class CoreServiceImplTestParent {
    ...
    /**
     * Because we scan twice, there are various rules for how we handle two different
     * events and what event we count them as.
     *
     * @throws Exception
     */
    @Test
    public void testFileCreationThenModificationCountsAsCreation() throws Exception {

        final File file = createFile();
        deleteFile(file); // Delete the file we just created so it doesn't exist :)
    ...
    @Test
    public void testFileDeletionThenCreationCountsAsModification() throws Exception {
    ...
    @Test
    public void testFileModificationThenDeletionCountsAsDeletion() throws Exception {
    ...
    @Test
    public void testFileModificationThenModificationCountsAsOnlyOneModification() throws Exception {
