...
//  APAR   PK93886 The display-name attribute on a tag directive can be different than the tag file name    09/18/2009  sartoris
        ...
        if (fragment) {
            ...
            if (type == null) {
				...
				try {
					...
					Class typeAttrClass = Class.forName(type, true, context
							.getJspClassloaderContext().getClassLoader());
