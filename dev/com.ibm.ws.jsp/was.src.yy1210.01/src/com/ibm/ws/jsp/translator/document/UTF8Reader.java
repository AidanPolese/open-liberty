...
public class UTF8Reader
    ...
    public void mark(int readAheadLimit) throws IOException {
        String msg = JspCoreException.getMsg("jsp.error.xml.operationNotSupported", new Object[] {"mark()","UTF-8"});
    ...
    private void invalidByte(int position, int count, int c) 
        ...
        String msg = JspCoreException.getMsg("jsp.error.xml.invalidByte", new Object[] {Integer.toString(position), Integer.toString(count)});
        throw new UTFDataFormatException(msg);
