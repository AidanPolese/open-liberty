...
import com.ibm.ws.security.jca.internal.AuthDataServiceImplTest.DoneMarker;
...
public class TestLoginModule implements LoginModule {
    ...
    public void initialize(Subject subject, CallbackHandler callbackHandler, Map<String, ?> sharedState, Map<String, ?> options) {
        ...
        ((DoneMarker) options.get("loginModuleInitializationDoneMarker")).mark();
    }
    ...
    public boolean login() throws LoginException {
        ...
        ((DoneMarker) options.get("loginDoneMarker")).mark();
        return true;
    }
    ...
    private void setPasswordCredentialInSubject(Callback[] callbacks) {
        ...
        PasswordCredential passwordCredential = new PasswordCredential("testUser", "testPassword".toCharArray());
