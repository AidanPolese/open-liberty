...
public class AlpineRuntimeTransformer implements ClassFileTransformer {
     ...
     */
    private final static TraceComponent tc = Tr.register(AlpineRuntimeTransformer.class, NLSConstants.GROUP, NLSConstants.LOGGING_NLS);
    ...
    protected static void setInjectAtTransform(boolean injectAtTransform) {
        AlpineRuntimeTransformer.injectAtTransform = injectAtTransform;
    ...
    protected static void setSkipDebugData(boolean skipDebugData) {
        AlpineRuntimeTransformer.skipDebugData = skipDebugData;
    }
    ...
    public static void traceStateChanged(final TraceComponent traceComponent) {
        ...
        if (!injectAtTransform && traceComponent.isEntryEnabled()) {
            ...
            if ((traceClass != null) && (traceClass != AlpineRuntimeTransformer.class)) {
                AlpineRuntimeTransformer.addTransformer();
    ...
    public static byte[] transform(byte[] bytes) throws IOException {
        ...
        AlpineTracingClassAdapter tracingClassAdapter = new AlpineTracingClassAdapter(visitor, true);
        try {
