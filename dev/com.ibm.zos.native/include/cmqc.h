 ...
 /*                                                              */             
 /*                 5655-R36                                     */             
 /*                 (C) Copyright IBM Corporation. 1993, 2011    */             
 /*                                                              */             
 ...
 /* Encoding */                                                                 
 #define MQENC_NATIVE                   0x00000311                              
 ...
 #define MQCMDL_CURRENT_LEVEL           710                                     
 ...
 #if defined(_LONG_LONG) || defined(_LP64)                                      
...
#if defined(__XPLINK__) && !defined(MQ_OS_LINKAGE)                              
 #if defined(__cplusplus)                                                       
   extern "C"                                                                   
 #endif                                                                         
#else                                                                           
 ...
 /****************************************************************/             
   ...
   extern "OS"                                                                  
 #else                                                                          
   #pragma linkage(CSQBCMT,OS)                                                  
 #endif                                                                         
#endif                                                                          
                                                                                
 void MQENTRY CSQBCMT (                                                         
   MQHCONN  Hconn,      /* I: Connection handle */                              
   PMQLONG  pCompCode,  /* OC: Completion code */                               
   PMQLONG  pReason);   /* OR: Reason code qualifying CompCode */               
 ...
 /****************************************************************/             
   ...
   extern "OS"                                                                  
 #else                                                                          
   #pragma linkage(CSQBBAK,OS)                                                  
 #endif                                                                         
#endif                                                                          
                                                                                
 void MQENTRY CSQBBAK (                                                         
   MQHCONN  Hconn,      /* I: Connection handle */                              
   PMQLONG  pCompCode,  /* OC: Completion code */                               
   PMQLONG  pReason);   /* OR: Reason code qualifying CompCode */               
