 ...
 */
public class WSJdbcConnection41 extends WSJdbcConnection {

    private static final TraceComponent tc = Tr.register(WSJdbcConnection41.class, AdapterUtil.TRACE_GROUP, AdapterUtil.NLS_FILE);
    ...
    public WSJdbcConnection41(WSRdbManagedConnectionImpl mc, Connection conn, Object key, Object currentThreadID) {
    ...
    public String getSchema() throws SQLException {
        ...
        try {
            ...
            FFDCFilter.processException(ex, "com.ibm.ws.rsadapter.jdbc.WSJdbcConnection41.getSchema", "62", this);
    ...
    public void setSchema(String schema) throws SQLException {
        ...
        try {
            ...
            FFDCFilter.processException(ex, "com.ibm.ws.rsadapter.jdbc.WSJdbcConnection41.setSchema", "96", this);
            throw proccessSQLException(ex);
        } catch (NullPointerException nullX) {
            // No FFDC code needed; we might be closed.
            throw runtimeXIfNotClosed(nullX);
    ...
    public int getNetworkTimeout() throws SQLException {
        ...
        try {
            ...
            FFDCFilter.processException(ex, "com.ibm.ws.rsadapter.jdbc.WSJdbcConnection41.getSchema", "111", this);
            throw proccessSQLException(ex);
        } catch (NullPointerException nullX) {
            // No FFDC code needed; we might be closed.
            throw runtimeXIfNotClosed(nullX);
    ...
    public void setNetworkTimeout(Executor executor, int milliseconds) throws SQLException {
        ...
        try {
            ...
            FFDCFilter.processException(ex, "com.ibm.ws.rsadapter.jdbc.WSJdbcConnection41.setNetworkTimeout", "145", this);
            throw proccessSQLException(ex);
        } catch (NullPointerException nullX) {
            // No FFDC code needed; we might be closed.
            throw runtimeXIfNotClosed(nullX);
