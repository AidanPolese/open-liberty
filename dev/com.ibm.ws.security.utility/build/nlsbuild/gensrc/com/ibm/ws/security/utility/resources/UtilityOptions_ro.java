...
public class UtilityOptions_ro extends java.util.ListResourceBundle
{
   ...
   private final static Object[][] resources= {
      ...
      { "createLTPAKeys.required-desc.password", "\tParola pentru cheile LTPA. Dac\u0103 nu este definit\u0103 nici o valoare, se va afi\u015fa un prompt." },
      ...
      { "sslCert.option-desc.keySize", "\tDimensiune cheie de certificat.  Dimensiunea implicit\u0103 este {7}." },
      ...
      { "sslCert.usage.options", "\t{0} createSSLCertificate '{--server nume_server|--client nume_client'}  \n\t--password parola [op\u0163iuni]" }
   };
}
