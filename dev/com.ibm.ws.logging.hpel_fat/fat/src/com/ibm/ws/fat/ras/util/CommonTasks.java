 ...
 */
package com.ibm.ws.fat.ras.util;
...
//    }
    ...
    /**
     * @Deprecated A shortcut to createLogEntries(ApplicationServer appServer, String loggerName, String message, Level
...
//    }
     ...
     * @throws MalformedURLException
     */
    public static WebResponse createLogEntries(ApplicationServer appServer, String loggerName, String message, Level level,
        ...
        WebConversation wc = new WebConversation();
        WebResponse response = wc.getResponse(CommonActions.getUrl(appServer, jsp + jspParams, false));
...
//    }
    ...
    public static boolean isHpelEnabled(Server aServer) throws Exception {
        LibertyServer server = aServer.getBackend();
...
//        return tempresult;
    ...
    public static boolean isHpelSensitiveTraceEnabled(Server aServer) throws Exception {
...
//        writeLogMsg(Level.INFO, "isHpelSensitiveTraceEnabled configObj is null");
    ...
    public static boolean setHpelSensitiveTraceEnabled(Server aServer, boolean enable) throws Exception {
...
//        return true;
     ...
     */
    public static boolean setHpelEnabled(Server aServer, boolean enable) throws Exception {
...
//        return true;
     ...
     */
    public static boolean setHpelEnabledAndBounce(Server aServer, boolean enable) throws Exception {
    ...
    public static boolean isTextLogEnabled(Server aServer) throws Exception {
        LibertyServer server = aServer.getBackend();
...
//        return (getTextLogChild(aServer).getAttributeByName("enabled").getValueAsBoolean());
    ...
    public static String getHpelTraceSpec(Server aServer) throws Exception {
        LibertyServer server = aServer.getBackend();
...
//        return (getUnifiedLoggingService(aServer).getAttributeByName("startupTraceSpec").getValueAsString());
     ...
     * @throws Exception
     */
    public static void setHpelTraceSpec(Server aServer, String newTraceSpec) throws Exception {
...
//            tmpWS.saveAndSync();
    ...
    public static RemoteFile getBinaryLogDir(Server aServer) throws Exception {
        String logDir = aServer.getBackend().getServerConfiguration().getLogging().getLogDirectory();
        return logDir == null ? aServer.getBackend().getFileFromLibertyServerRoot("logs") :
                        new RemoteFile(HpelSetup.getNodeUnderTest().getMachine(), logDir);
...
//                        .getAttributeByName("dataDirectory").getValueAsString()));
    ...
    public static RemoteFile getBinaryTraceDir(Server aServer) throws Exception {
        String logDir = aServer.getBackend().getServerConfiguration().getLogging().getLogDirectory();
        return logDir == null ? aServer.getBackend().getFileFromLibertyServerRoot("logs") :
                        new RemoteFile(HpelSetup.getNodeUnderTest().getMachine(), logDir);
...
//                        .getAttributeByName("dataDirectory").getValueAsString()));
    ...
    public static RemoteFile getTextLogDir(Server aServer) throws Exception {
        String logDir = aServer.getBackend().getServerConfiguration().getLogging().getLogDirectory();
        return logDir == null ? aServer.getBackend().getFileFromLibertyServerRoot("logs") :
                        new RemoteFile(HpelSetup.getNodeUnderTest().getMachine(), logDir);
...
//                                                                                                                               "dataDirectory").getValueAsString()));
     ...
     */
    public static boolean getLogRepositoryFromServer(Server aServer, RemoteFile destinationDir) throws Exception {
     ...
     * @return true if the copy was successful.
     */
    public static boolean getZippedLogRepositoryFromServer(Server aServer, RemoteFile destinationZipFile) throws Exception {
     ...
     * @return true if the copy was successful.
     */
    public static boolean getTraceRepositoryFromServer(Server aServer, RemoteFile destinationDir) throws Exception {
     ...
     * @return true if the copy was successful.
     */
    public static boolean getZippedTraceRepositoryFromServer(Server aServer, RemoteFile destinationZipFile) throws Exception {
        return zipAndCopyARepositoryFromServer(aServer, destinationZipFile, CommonTasks.TRACE);
    }

    private static boolean zipAndCopyARepositoryFromServer(Server aServer, RemoteFile destinationZipFile, String repositoryType) throws Exception {
        ...
        String URL = CommonActions.getUrl((ApplicationServer) aServer, URLsuffix, false);
     ...
     * @return true if the copy was successful.
     */
    public static boolean getRepositoryFromServer(Server aServer, RemoteFile destinationDir) throws Exception {
        RemoteFile rRepLogDataDir = new RemoteFile(aServer.getNode().getMachine(), CommonTasks.getBinaryLogDir(aServer), "logdata");
        RemoteFile rRepTraceDataDir = new RemoteFile(aServer.getNode().getMachine(), CommonTasks.getBinaryTraceDir(aServer),
                        "tracedata");
     ...
     * @throws Exception
     */
    public static void addBootstrapProperty(Server appServer, String propertyName, String propertyValue) throws Exception {

        LibertyServer server = appServer.getBackend();
        RemoteFile bootstrapFile = server.getServerBootstrapPropertiesFile();
        Properties bootstrapProps = new Properties();
...
//    }
     ...
     *         needed.
     * */
//    public static boolean setCustomJVMPropertyInConfig(ApplicationServer theServer, CommonTasks.zOSProcessType zProcType,
...
//    }
     ...
     * */
//    public String getCustomJVMPropertyInConfig(ApplicationServer theServer, CommonTasks.zOSProcessType zProcType, String propertyName)
//                    throws Exception {
