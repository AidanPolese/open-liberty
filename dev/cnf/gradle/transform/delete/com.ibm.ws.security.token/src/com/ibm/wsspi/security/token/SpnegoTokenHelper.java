...
public class SpnegoTokenHelper {
     ...
     */
    public static String buildSpnegoAuthorizationFromCallerSubject(final String spn, final int lifetime, final boolean delegate)
                    throws WSSecurityException, GSSException, PrivilegedActionException {
    ...
    public static String buildSpnegoAuthorizationFromNativeCreds(final String spn, final int lifetime,
        ...
        try {
            token = (String) AccessController.doPrivileged(new PrivilegedExceptionAction<Object>() {
                ...
                {
                    String token = null;
                    String savedProperty = Krb5Helper.setPropertyAsNeeded(Krb5Helper.USE_SUBJECT_CREDS_ONLY, "false");

                    try {
                        GSSCredential gssCred = Krb5Helper.getGSSCred(null, null, SPNEGO_MECH_OID, GSSCredential.INITIATE_ONLY, GSSCredential.INDEFINITE_LIFETIME,
                                                                      GSSCredential.INDEFINITE_LIFETIME);
                        token = Krb5Helper.buildSpnegoAuthorization(gssCred, spn, lifetime, delegate);
                    } finally {
                        Krb5Helper.restorePropertyAsNeeded(Krb5Helper.USE_SUBJECT_CREDS_ONLY, savedProperty, "false");
                    }
                    return token;
                }
            });
                    ...
                    try {
                        ...
                        GSSCredential gssCred = (GSSCredential) Subject.doAs(subject, new PrivilegedExceptionAction<Object>() {
                            ...
                            public Object run() throws GSSException, Exception {
                                GSSCredential innerCred = Krb5Helper.getGSSCred(null, upn, SPNEGO_MECH_OID, GSSCredential.INITIATE_ONLY,
                                                                                GSSCredential.INDEFINITE_LIFETIME,
                                                                                GSSCredential.INDEFINITE_LIFETIME);
                                return innerCred;
                            }
    ...
    public static String buildSpnegoAuthorizationFromUseridPassword(final String spn, final String userid, @Sensitive final String password,
                                                                    final String jaasLoginContextEntry, final int lifetime, final boolean delegate)
                    throws GSSException, LoginException, PrivilegedActionException {
            ...
            token = (String) AccessController.doPrivileged(new PrivilegedExceptionAction<Object>() {
                ...
                public Object run() throws LoginException, GSSException, PrivilegedActionException {
                    ...
                    GSSCredential gssCred = (GSSCredential) Subject.doAs(useSubject, new PrivilegedExceptionAction<Object>()
                    {
                        @Override
                        public Object run() throws GSSException, Exception {
                            GSSCredential innerCred = Krb5Helper.getGSSCred(null, userid, SPNEGO_MECH_OID, GSSCredential.INITIATE_ONLY,
                                                                            GSSCredential.INDEFINITE_LIFETIME,
                                                                            GSSCredential.INDEFINITE_LIFETIME);
