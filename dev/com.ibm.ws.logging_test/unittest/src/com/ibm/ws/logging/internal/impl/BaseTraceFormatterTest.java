...
public class BaseTraceFormatterTest {
    ...
    enum StringResults {
        testNullAll("] 00000001               2   null",
                    "] 00000001 id=                                                                      2 null",
                    "] 00000001  2 UOW= source= thread=[main]" + LoggingConstants.nl + "          null"),

        testSource("] 00000001 source        2   null",
                   "] 00000001 id=         source                                                       2 null",
                   "] 00000001  2 UOW= source=source thread=[main]" + LoggingConstants.nl + "          null"),

        testClass("] 00000001 class         2 class  null",
                  "] 00000001 id=         class                                                        2 null",
                  "] 00000001  2 UOW= source= class=class thread=[main]" + LoggingConstants.nl + "          null"),

        testSourceAndClass("] 00000001 source        2 class  null",
                           "] 00000001 id=         class                                                        2 null",
                           "] 00000001  2 UOW= source=source class=class thread=[main]" + LoggingConstants.nl + "          null"),

        testMethod("] 00000001 source        2  method null",
                   "] 00000001 id=         source                                                       2 method null",
                   "] 00000001  2 UOW= source=source method=method thread=[main]" + LoggingConstants.nl + "          null"),
        testMessage("] 00000001 source        2  method ta-da!",
                    "] 00000001 id=         source                                                       2 method ta-da!",
                    "] 00000001  2 UOW= source=source method=method thread=[main]" + LoggingConstants.nl + "          ta-da!"),
        testLongName("] 00000001 abcdefghijklm 2  method ta-da!",
                     "] 00000001 id=         cdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 2 method ta-da!",
                     "] 00000001  2 UOW= source=abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 method=method thread=[main]"
                                     + LoggingConstants.nl + "          ta-da!"),
        testId("] 00000001 abcdefghijklm 2  method ta-da!",
               "] 00000001 id=" + idHash + " cdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 2 method ta-da!",
               "] 00000001  2 UOW= source=abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 method=method id=" + idHash + " thread=[main]"
                               + LoggingConstants.nl + "          ta-da!"),
        testMessageLevel("] 00000001 abcdefghijklm I  method ta-da!",
                         "] 00000001 id=" + idHash + " cdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 I method ta-da!",
                         "] 00000001  I UOW= source=abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 method=method id=" + idHash + " thread=[main]"
                                         + LoggingConstants.nl + "          ta-da!"),
        testTrEntry("] 00000001 source        >  method " + BaseTraceFormatter.ENTRY,
                    "] 00000001 id=         source                                                       > method " + BaseTraceFormatter.ENTRY,
                    "] 00000001  > UOW= source=source method=method thread=[main]"
                                    + LoggingConstants.nl + "          " + BaseTraceFormatter.ENTRY),
        testTrEntryWithExitParam("] 00000001 source        >  method " + BaseTraceFormatter.ENTRY + " " +
        ...
        testLoggerEntering("] 00000001 source        >  method ENTRY",
                           "] 00000001 id=         source                                                       > method ENTRY",
                           "] 00000001  > UOW= source=source method=method thread=[main]"
                                           + LoggingConstants.nl + "          ENTRY"),
        testLoggerEnteringParam("] 00000001 source        >  method ENTRY aaa",
                                "] 00000001 id=         source                                                       > method ENTRY aaa",
                                "] 00000001  > UOW= source=source method=method thread=[main]"
                                                + LoggingConstants.nl + "          ENTRY aaa"),
        testLoggerEnteringParams("] 00000001 source        >  method ENTRY aaa bbb ccc",
                                 "] 00000001 id=         source                                                       > method ENTRY aaa bbb ccc",
                                 "] 00000001  > UOW= source=source method=method thread=[main]"
                                                 + LoggingConstants.nl + "          ENTRY aaa bbb ccc"),
        testTrExit("] 00000001 source        <  method " + BaseTraceFormatter.EXIT,
                   "] 00000001 id=         source                                                       < method " + BaseTraceFormatter.EXIT,
                   "] 00000001  < UOW= source=source method=method thread=[main]"
                                   + LoggingConstants.nl + "          " + BaseTraceFormatter.EXIT),
        testTrExitWithEntryParam("] 00000001 source        <  method " + BaseTraceFormatter.EXIT + " " +
        ...
        testLoggerExiting("] 00000001 source        <  method RETURN",
                          "] 00000001 id=         source                                                       < method RETURN",
                          "] 00000001  < UOW= source=source method=method thread=[main]"
                                          + LoggingConstants.nl + "          RETURN"),
        testLoggerExitingParam("] 00000001 source        <  method RETURN aaa",
                               "] 00000001 id=         source                                                       < method RETURN aaa",
                               "] 00000001  < UOW= source=source method=method thread=[main]"
