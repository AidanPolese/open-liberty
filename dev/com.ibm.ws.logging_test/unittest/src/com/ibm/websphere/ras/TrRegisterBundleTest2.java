 ...
 */
@TraceOptions(messageBundle = "com.ibm.testBundle", traceGroups = { "multigroup1", "multigroup2" })
public class TrRegisterBundleTest2 {
    static {
        LoggingTestUtils.ensureLogManager();
    }
    static final String myName = TrRegisterBundleTest2.class.getName();
