...
IBM-API-Package: org.eclipse.microprofile.jwt; type="spec"
Subsystem-Name: Micro Profile Json Web Token 1.0
-features=com.ibm.websphere.appserver.servlet-3.0; ibm.tolerates:=3.1, \
  com.ibm.websphere.appserver.jwt-1.0, \
  com.ibm.websphere.appserver.jsonp-1.0, \
  com.ibm.websphere.appserver.httpcommons-1.0
-bundles=com.ibm.ws.security.mp.jwt,\
  com.ibm.websphere.org.eclipse.microprofile.jwt.1.0; location:="dev/api/spec/,lib/" \
