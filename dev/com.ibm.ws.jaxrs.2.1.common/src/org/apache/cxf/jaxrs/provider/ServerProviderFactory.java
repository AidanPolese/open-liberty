...
//        super.clearThreadLocalProxies();
    ...
    private class ServerConfigurationImpl implements Configuration {
        ...
        public Set<Class<?>> getClasses() {
            return application != null ? application.getProvider().getClasses() : Collections.<Class<?>> emptySet();
        }
            ...
            if (isRegistered(cls)) {
                if (ContainerRequestFilter.class.isAssignableFrom(cls)) {
                    ...
                    map.put(ContainerRequestFilter.class,
                            getPriority(isPreMatch ? preMatchContainerRequestFilters : postMatchContainerRequestFilters.values(), cls, ContainerRequestFilter.class));
                }
        ...
        public Map<String, Object> getProperties() {
            return application != null ? application.getProperties() : Collections.<String, Object> emptyMap();
        }
