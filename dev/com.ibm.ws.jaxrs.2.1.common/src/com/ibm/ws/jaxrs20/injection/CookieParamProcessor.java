...
public class CookieParamProcessor extends InjectionSimpleProcessor<CookieParam> {
    ...
    private static final TraceComponent tc = Tr.register(CookieParamProcessor.class);
    ...
    @Override
    public InjectionBinding<CookieParam> createInjectionBinding(CookieParam annotation, Class<?> instanceClass, Member member)
        ...
        CookieParamInjectionBinding binding =
                        new CookieParamInjectionBinding(annotation, ivNameSpaceConfig);
