...
public interface InstallKernel {
     ...
     */
    public Collection<String> installFeature(String featureId, String toExtension, boolean acceptLicense, ExistsAction existsAction, String userId, String password) throws InstallException;
     ...
     * @throws InstallException if there is an error
     */
    public Collection<String> installFeature(Collection<String> featureIds, String toExtension, boolean acceptLicense, ExistsAction existsAction, String userId, String password) throws InstallException;
     ...
     * @throws InstallException if there is an error
     */
    public Collection<String> installFeature(Collection<String> featureIds, File fromDir, String toExtension, boolean acceptLicense, ExistsAction existsAction, boolean offlineOnly) throws InstallException;
     ...
     * @throws InstallException if there is an error
     */
    public Map<String, Collection<String>> installAsset(Collection<String> assetIds, File fromDir, RepositoryConnectionList loginInfo, String proxyHost, String proxyPort, String proxyUser,
