...
public final class ArchiveUtils {
    ...
    public static enum ArchiveFileType {
        ...
        public boolean isType(String archiveFile) {
            return (null == archiveFile || archiveFile.equals("")) ?
                            false : archiveFile.toLowerCase().endsWith(this.extension);
        }
    }
    ...
    public static String getLicenseAgreement(final JarFile jar, final Map<String, String> manifestAttrs) {
        ...
        LicenseProvider licenseProvider = (licenseAgreementPrefix != null) ?
                        ZipLicenseProvider.createInstance(jar, licenseAgreementPrefix) : null;
