...
//created new annotation called HitCounted ??
@HitCounted
@Interceptor
...
/* package-private */ class HitCountedInterceptor {
    ...
    @Inject
    private HitCountedInterceptor(@Intercepted Bean<?> bean, MetricRegistry registry, MetricResolver2 resolver) {
        this.bean = bean;
    ...
    private <E extends Member & AnnotatedElement> Object countedCallable(InvocationContext context, E element) throws Exception {
        ...
        try {
            ...
            //fairly sure there is no need for following logic
        }
    }
}
