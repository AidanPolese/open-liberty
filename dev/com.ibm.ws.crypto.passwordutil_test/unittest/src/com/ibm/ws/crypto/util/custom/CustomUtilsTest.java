...
public class CustomUtilsTest {
    ...
    private static final String VALUE_DIR = "../com.ibm.ws.crypto.passwordutil_test/build/unittest/test_data";
    ...
    private static final String VALUE_EXTENSION_JAR = "build/unittest/test_data/custom_encryption/bin/tools/extensions/ws-customPasswordEncryption/valid.jar";
