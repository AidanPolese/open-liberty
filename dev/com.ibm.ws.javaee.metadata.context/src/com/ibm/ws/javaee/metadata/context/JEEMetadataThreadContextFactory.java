...
public interface JEEMetadataThreadContextFactory {
    ...
    /**
     * Creates thread context for the given metadata.
     * 
     ...
     * @param metadataIdentifier identifies the metadata
     * 
     * @return context that can be applied to a thread.
     * 
     * @see javax.enterprise.concurrent.ManagedTask#getExecutionProperties()
     */
    ThreadContext createThreadContext(Map<String, String> execProps, String metadataIdentifier);
}
