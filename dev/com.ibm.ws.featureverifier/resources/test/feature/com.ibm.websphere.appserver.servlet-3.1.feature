...
-jars=com.ibm.websphere.appserver.api.servlet; location:=dev/api/ibm/, \
 com.ibm.websphere.appserver.spi.servlet; location:=dev/spi/ibm/
-files=dev/api/ibm/schema/ibm-common-bnd_1_2.xsd, \
 dev/spi/ibm/javadoc/com.ibm.websphere.appserver.spi.servlet_1.1-javadoc.zip, \
 ...
 dev/api/ibm/javadoc/com.ibm.websphere.appserver.api.servlet_1.0-javadoc.zip, \
