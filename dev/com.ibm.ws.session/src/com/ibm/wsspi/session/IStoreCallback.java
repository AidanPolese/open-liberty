 ...
 *
 *  @(#) 1.4 SERV1/ws/code/web.session.core/src/com/ibm/wsspi/session/IStoreCallback.java, WASCC.web.session.core, WASX.SERV1, o0901.11 5/30/08 16:34:43 [1/9/09 15:01:33]
 *
 * @(#)file   IStoreCallback.java
 * @(#)version   1.4
 * @(#)date      5/30/08
 *
 *COPYRIGHT_END*************************************************************/
