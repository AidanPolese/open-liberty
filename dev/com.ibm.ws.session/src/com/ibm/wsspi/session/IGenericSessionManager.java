 ...
 *
 *  @(#) 1.3 SERV1/ws/code/web.session.core/src/com/ibm/wsspi/session/IGenericSessionManager.java, WASCC.web.session.core, WASX.SERV1, o0901.11 6/6/08 13:50:11 [1/9/09 15:01:31]
 *
 * @(#)file   IGenericSessionManager.java
 * @(#)version   1.3
 * @(#)date      6/6/08
 *
 *COPYRIGHT_END*************************************************************/
