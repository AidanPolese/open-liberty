 ...
 *
 *  @(#) 1.1 SERV1/ws/code/web.session.core/src/com/ibm/wsspi/session/ILoader.java, WASCC.web.session.core, WASX.SERV1, o0901.11 10/13/06 15:53:15 [1/9/09 15:01:31]
 *
 * @(#)file   ILoader.java
 * @(#)version   1.1
 * @(#)date      10/13/06
