 ...
 *
 *  @(#) 1.3 SERV1/ws/code/web.session.core/src/com/ibm/wsspi/session/ISession.java, WASCC.web.session.core, WASX.SERV1, o0901.11 5/30/08 16:34:33 [1/9/09 15:01:32]
 *
 * @(#)file   ISession.java
 * @(#)version   1.3
 * @(#)date      5/30/08
