 ...
 *
 *  @(#) 1.8 SERV1/ws/code/web.session.core/src/com/ibm/wsspi/session/SessionAffinityContext.java, WASCC.web.session.core, WASX.SERV1, uu1050.39 6/7/10 13:58:38 [12/22/10 17:06:12]
 *
 * @(#)file   SessionAffinityContext.java
 * @(#)version   1.8
 * @(#)date      6/7/10
 *
 *COPYRIGHT_END*************************************************************/
