 ...
 *
 *  @(#) 1.3 SERV1/ws/code/web.session.shell/src/com/ibm/websphere/servlet/session/IBMSession.java, WASCC.web.session, WASX.SERV1, uu1050.39 6/29/09 16:17:57 [12/22/10 17:06:12]
 *
 * @(#)file   IBMSession.java
 * @(#)version   1.3
 * @(#)date      6/29/09
 *
 *COPYRIGHT_END*************************************************************/
