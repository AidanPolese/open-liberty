 ...
 *
 *  @(#) 1.7 SERV1/ws/code/web.session.core/src/com/ibm/ws/session/StoreCallback.java, WASCC.web.session.core, WASX.SERV1, o0901.11 5/30/08 16:34:49 [1/9/09 15:01:30]
 *
 * @(#)file   StoreCallback.java
 * @(#)version   1.7
 * @(#)date      5/30/08
 *
 *COPYRIGHT_END*************************************************************/
