 ...
 *
 *  @(#) 1.6 SERV1/ws/code/web.session.core/src/com/ibm/ws/session/SessionStateEventDispatcher.java, WASCC.web.session.core, WASX.SERV1, o0901.11 5/30/08 16:34:47 [1/9/09 15:01:29]
 *
 * @(#)file   SessionStateEventDispatcher.java
 * @(#)version   1.6
 * @(#)date      5/30/08
 *
 *COPYRIGHT_END*************************************************************/
