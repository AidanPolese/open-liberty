 ...
 *
 *  @(#) 1.7 SERV1/ws/code/web.session.shell/src/com/ibm/ws/session/SessionContextRegistry.java, WASCC.web.session, WASX.SERV1, o0901.11 3/12/08 09:24:43 [1/9/09 15:00:59]
 *
 * @(#)file   SessionContextRegistry.java
 * @(#)version   1.7
 * @(#)date      3/12/08
 *
 *COPYRIGHT_END*************************************************************/
