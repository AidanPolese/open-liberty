 ...
 *
 *  @(#) 1.20 SERV1/ws/code/web.session.shell/src/com/ibm/ws/session/SessionAffinityManager.java, WASCC.web.session, WASX.SERV1, uu1050.39 7/30/10 16:33:29 [12/22/10 17:06:13]
 *
 * @(#)file   SessionAffinityManager.java
 * @(#)version   1.20
 * @(#)date      7/30/10
 *
 *COPYRIGHT_END*************************************************************/
