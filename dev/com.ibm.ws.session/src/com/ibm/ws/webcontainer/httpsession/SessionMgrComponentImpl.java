 ...
 *
 *  @(#) 1.4 SERV1/ws/code/web.session.shell/src/com/ibm/ws/webcontainer/httpsession/SessionMgrComponentImpl.java, WASCC.web.session, WASX.SERV1, o0901.11 3/12/08 09:24:37 [1/9/09 15:01:02]
 *
 * @(#)file   SessionMgrComponentImpl.java
 * @(#)version   1.4
 * @(#)date      3/12/08
 *
 *COPYRIGHT_END*************************************************************/
