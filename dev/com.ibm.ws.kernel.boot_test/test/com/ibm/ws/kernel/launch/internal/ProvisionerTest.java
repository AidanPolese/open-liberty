...
public class ProvisionerTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        TestUtils.setKernelUtilsBootstrapLibDir(new File("bin_test/test data/lbr/lib"));
        TestUtils.setUtilsInstallDir(new File("bin_test/test data/lbr"));
    ...
    public void testInstallExistingBundle() throws Exception {
        ...
        File simple_1 = new File("bin_test/test data/lbr/lib", "x.y_1.0.jar");
