...
/**
 * Represents an exception while processing the request with microprofile jwt.
 *
 */
public class MpJwtProcessingException extends Exception {
    private static TraceComponent tc = Tr.register(MpJwtProcessingException.class,
    ...
    /**
     * Creates a MpJwtProcessingException.
     *
     ...
     * @param objects
     */
    public MpJwtProcessingException(String msgKey, Exception cause, Object[] objects) {
     ...
     */
    public MpJwtProcessingException(Exception cause) {
        this(cause, false);
    }
     ...
     */
    public MpJwtProcessingException(Exception cause, boolean ffdcAlready) {
     ...
     * @param objects
     */
    public MpJwtProcessingException(String msgKey, Exception cause, boolean ffdcAlready, Object[] objects) {
        super(cause);
        this.ffdcAlready = ffdcAlready;
    ...
    static public String formatMessage(String msgKey, String defaultMsg, Object[] objects) {
        return TraceNLS.getFormattedMessage(MpJwtProcessingException.class,
                TraceConstants.MESSAGE_BUNDLE,
                msgKey,
                objects,
                defaultMsg);
    ...
    protected void handleUnexpectException(Exception cause) {
        ...
        _msgKey = "MPJWT_SERVER_INTERNAL_LOG_ERROR";
    ...
    private void setExternalMsg() {
        _msgKey = "MPJWT_AUTHENTICATION_FAIL";
