...
public class PermissionManagerTest {
    ...
    private WLPDynamicPolicy wlpDynamicPolicy = mock.mock(WLPDynamicPolicy.class);
    
    private Policy savedPolicy;
    private Permission fileReadPermission = new FilePermission("", "read");
	private Permission propertyReadPermission = new PropertyPermission("os.name", "read");
