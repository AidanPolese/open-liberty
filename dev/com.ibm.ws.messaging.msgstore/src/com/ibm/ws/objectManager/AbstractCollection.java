...
/**
 * The root of the Abstract collections, depends on iterator, which must be implemented,
 * as the basis of its operation. This provides a new collection by extending
 * ManagedObject.
 * 
 * @see Collection
                ...
                implements Collection, Printable
{
    ...
    private static Trace trace = ObjectManager.traceFactory.getTrace(AbstractCollection.class,
     ...
     * (non-Javadoc)
     * 
     * @see com.ibm.ws.objectManager.Collection#clear(com.ibm.ws.objectManager.Transaction)
     */
