 ...
 * --------------- -------- -------- ------------------------------------------
 * 562227          20/11/08 gareth   Only reserve space in remove() if entry found
 * 607710          21/08/09 gareth   Add isAnyTracingEnabled() check around trace
 * PM12992         06/04/26 abanks   Correct availableSize calculation during remove, and correct iterator
 * 657719          24/06/10 abanks   Fix reserved space leak
 * ============================================================================
 */
