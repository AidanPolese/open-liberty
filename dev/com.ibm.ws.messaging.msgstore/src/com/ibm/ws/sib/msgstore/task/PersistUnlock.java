...
/**
 * Class coordinates the unlocking of a persistently locked link
 *
 */
public final class PersistUnlock extends Task
{
    ...
    {
        getLink().abortPersistUnlock(transaction);
    }
    ...
    public final void commitExternal(final PersistentTransaction transaction) throws SevereMessageStoreException
    {
        ...
        getLink().commitPersistUnlock(transaction);
    ...
    {
        if (TraceComponent.isAnyTracingEnabled() && tc.isEntryEnabled()) SibTr.entry(this, tc, "preCommit");
