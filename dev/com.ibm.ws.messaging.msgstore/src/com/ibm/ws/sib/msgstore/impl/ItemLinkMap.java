 ...
 * --------------- -------- -------- ------------------------------------------
 *                 13/08/04 drphill  Original
 * 288073          13/07/05 schofiel Dump consolidation
 * 597160          25/06/09 gareth   Make _size atomic to avoid concurrent access
 * 666212          20/08/10 lohit    lazily create the AbstractItemLink object
 * ============================================================================
 */
