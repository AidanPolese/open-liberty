...
public class BatchLocationServiceImpl implements BatchLocationService {
     ...
     * 
     */
    @Reference(target = "(jmx.objectname=WebSphere:feature=channelfw,type=endpoint,name=defaultHttpEndpoint-ssl)",
    ...
    public boolean isLocalJobExecution(long executionId) {
        ...
        return (jobExecution instanceof WSJobExecution)
                    ? isLocalJobExecution( (WSJobExecution) jobExecution )
                    : true;
    }
    ...
    public JobExecution assertIsLocalJobExecution(long executionId) throws BatchJobNotLocalException {
        ...
        if ( jobExecution instanceof WSJobExecution && ! isLocalJobExecution((WSJobExecution)jobExecution) ) {
            throw new BatchJobNotLocalException( (WSJobExecution)jobExecution,
                                                 getBatchRestUrl(),
                                                 getServerId() );
        }
        return jobExecution;
