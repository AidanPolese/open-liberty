...
public class BatchStatusValidator  {
     ...
     */
    public static void validateStatusAtInstanceRestart(long jobInstanceId, Properties restartJobParameters) 
	 ...
	 */
	public static void validateStatusAtExecutionRestart(long previousExecutionId, Properties restartJobParameters) 
			throws JobRestartException, JobExecutionNotMostRecentException, JobExecutionAlreadyCompleteException {
	...
	private static class Helper {
		 ...
		 */
		private void validateJobNotCompleteOrAbandonded()
				throws JobRestartException, JobExecutionAlreadyCompleteException {
...
//				String msg = getFormattedMessage("job.restart.denied", new Object[]{jobInstance.getInstanceId()}, "The job instance " + jobInstance.getInstanceId() + " cannot be restarted because the most recent execution is still in a non-final state.");
		...
		private String getFormattedMessage(String msgKey, Object[] fillIns,
			...
			ResourceBundle resourceBundle = ResourceBundle
					.getBundle("com.ibm.jbatch.container.internal.resources.JBatchMessages");
