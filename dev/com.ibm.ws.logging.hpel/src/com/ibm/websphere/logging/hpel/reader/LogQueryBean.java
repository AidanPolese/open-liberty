 ...
 * ----------------------------------------------------------------------------
 * F017049-16882       8.0      01-10-2010  mcasile     Part created.
...
public class LogQueryBean implements Serializable {
    ...
    public String toString() {
        return "LogQueryBean [excludeLoggers=" + Arrays.toString(excludeLoggers) + ", includeLoggers=" + Arrays.toString(includeLoggers) + ", maxLevel=" + maxLevel + ", maxTime=" + maxTime + ", messageContent=" + Arrays.toString(messageContent) + ", minLevel=" + minLevel + ", minTime=" + minTime + ", threadIDs=" + Arrays.toString(threadIDs) + "]";
    }
}
