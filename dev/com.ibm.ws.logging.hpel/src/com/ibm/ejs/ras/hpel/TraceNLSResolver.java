// %Z% %I% %W% %G% %U% [%H% %T%]
/**
 * COMPONENT_NAME: WAS.ras.hpel
 *
 * ORIGINS: 27         (used for IBM originated files)
 *
 * IBM Confidential OCO Source Material
 * 5724-J08, 5724-I63, 5724-H88, 5724-H89, 5655-N02, 5733-W70 (C) COPYRIGHT International Business Machines Corp. 1998,2009
 ...
 * ----------------------------------------------------------------------------
 * F017049-18766 8.0   04-16-2010  mcasile     Added in correct copyright and header
 */
