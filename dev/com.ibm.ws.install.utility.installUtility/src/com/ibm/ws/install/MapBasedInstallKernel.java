 ...
 * create a URLClassLoader to the wlp/bin/tools/ws-installUtility.jar and then instanciate this
 * class by the name "com.ibm.ws.install.MapBasedInstallKernel". Once instanciated it initiates
 ...
 * <li>If it is not set, the default is "mapBasedInstallKernel".</li></ul>
 * </li>
 * </ul>
 * </p>
 * 
...
public class MapBasedInstallKernel implements Map {
    ...
    public MapBasedInstallKernel() {}

    private String getMessage(String key, Object... args) {
        if (messagesRes == null) {
            if (locale == null)
                locale = Locale.getDefault();
            messagesRes = ResourceBundle.getBundle("com.ibm.ws.install.internal.resources.MapBasedInstallKernelMessages", locale);
        }
    ...
    private URL getURL(File installDir, String[] bundle) {
        ...
        File[] jars = libDir.listFiles(new FilenameFilter() {
            ...
            public boolean accept(File dir, String name) {
                return MapBasedInstallKernel.accept(name, fName, min, max);
            }
        });
