 ...
 * -------------- ----------- -------- -------------------------------------
 * d284571        20-Jul-2005 djvines  Creation - taken from WAS.ffdc
 * 284629.1.1     06-Dec-2005 djvines  reduce set of dummy methods
 * d412803        02-Jan-2007 djvines  Add support for actually invoking diagnostic modules
 * d474731        15-Oct-2007 djvines  directives is never read
 * **************************************************************************
 */
