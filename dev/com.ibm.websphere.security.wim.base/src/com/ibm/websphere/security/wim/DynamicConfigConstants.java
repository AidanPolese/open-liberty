...
public interface DynamicConfigConstants
{
     ...
     * 									which can contain all configuration setting specific to LDAP adapter. If the repository does not need any specific setting (like Database repository), this parameter is not needed.
     * </ul>
     * 
     */
