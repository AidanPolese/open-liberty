...
// com.ibm.ws.security.jsr375.cdi package in order to register the class as
// a managed bean. 
...
public class FormAuthenticationMechanism implements HttpAuthenticationMechanism {
    ...
    private AuthenticationStatus gotoLoginPage(Properties props, HttpServletRequest req, HttpServletResponse rsp) {
        String loginPage = (String) props.get(JSR375Constants.LOGIN_TO_CONTINUE_LOGINPAGE);
    ...
    private boolean getUseForwardToLogin(Properties props) {
        ...
        Boolean value = (Boolean) props.get(JSR375Constants.LOGIN_TO_CONTINUE_USEFORWARDTOLOGIN);
        if (value != null) {
