 ...
 *  
 * The class implemented Statistic type in JSR-77 performance model
 * with some extension (e.g., include PmiDataInfo for static info.
 *
 * It is a base class for all other xxxStatistic classes.
 * In this base class, it has the following members: 
 * id, startTime, lastSampleTime, name, unit, description, and PmiDataInfo
 * 
 *  
 */
