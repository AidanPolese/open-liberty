 ...
 * 
 * The class implementing WpdCollection. It has the following members:
 *    name, type, dataMembers, and subCollections.
 * 
 * Upon receiving a client request for perf data retrieval, the serve will create objects
 * of WpdCollectionImpl and pass them to client. The client will use the methods
 * exported in the interface to get all the data.
 *  
 */
