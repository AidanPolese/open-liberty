...
public class TraceNLSResolver {
    ...
    Boolean debugTraceNLSResolver = null;
     ...
     *         appropriate.
     */
    public String getMessage(Class<?> aClass, ResourceBundle bundle, String bundleName,
                             String key, Object[] args, String defaultString,
                             boolean format, Locale locale,
                             boolean quiet) {
        ...
        try {
            ...
            if (bundleName == null) {
                ...
                if (!quiet)
                    logEvent(svNullBundleName, new Object[] { key, defaultString });
     ...
     * @param locales
     *            the possible Locales to use when looking up the ResourceBundle.
     *            Resource bundles from the front of the list are preferred over
     *            resource bundles from the back of the list. If the list is null
     *            or empty, the default Locale will be used.
    ...
    static class LocaleListControl extends Control {
        final private List<Locale> locales;
        ...
        /**
         * Merges the Locales which were passed in via formatMessage with the
         * base Control's candidate locales. This is basically a guess at what
         * to do here...
         * 
         * @return The merged candidate Locales.
         * 
         * @see Control#getCandidateLocales(String, Locale)
         */
        @Override
        public List<Locale> getCandidateLocales(String baseName, Locale locale) {
            List<Locale> allLocales = new ArrayList<Locale>(locales);
    ...
    protected final static void logEvent(String message, Object[] args) {
        if (getInstance().makeNoise && tc.isEventEnabled()) {
            if (args == null)
                ...
                com.ibm.websphere.ras.Tr.event(tc, MessageFormat.format(message, args));
        }
    }
}