...
public class SharedConstants {
     ...
     * windows.
     */
    public static final String TEST_DATA_DIR = "../com.ibm.ws.kernel.feature_test/build/unittest/test data";

    public static final File TEST_DATA_FILE = new File(TEST_DATA_DIR);

    /** Test dist dir: where our generated sample jars live */
    public static final String TEST_DIST_DIR = "../com.ibm.ws.kernel.feature_test/build/unittest/test data/lib";
}
