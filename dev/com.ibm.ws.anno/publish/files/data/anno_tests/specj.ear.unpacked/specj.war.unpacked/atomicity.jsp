...
<%@ page import="java.util.Collection, java.util.Iterator, java.util.HashMap, java.math.BigDecimal, org.spec.jappserver.servlet.helper.*" session="true" isThreadSafe="true" isErrorPage="false"%>
<TABLE width="645" align="left">
		<UL>
			...
			<FONT size="5" color="#000000"><b>SPECjAppServer2008 Transaction Atomicity Test</b></FONT>
			<BR></BR>
		</UL>
<P><BR>
</P>
