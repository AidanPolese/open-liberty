...
<%
                        try {
                          for (Item idb : itemInfo.vehicles) {
                      %>
								<TR bgcolor="#fafcb6" align="center">
									...
									<TD><%=specUtils.formatCurrency(idb.getPrice().multiply(
                  						SpecUtils.ONE.subtract(idb.getDiscount())).setScale(2,
                  							BigDecimal.ROUND_DOWN))%>&nbsp;</TD>
									<TD><%=specUtils.formatNumber(idb.getDiscount().multiply(
                 							SpecUtils.HUNDRED))%>%&nbsp;</TD>
...
-->
								...
								<%
								    ...
								    System.out.println("purchase.jsp: error displaying user holdings");
								  }
								%>
							</TBODY>
                        </TABLE>
