...
public class SCITest_SCIAbsoluteNoOthers_war_Test extends AnnotationTest_BaseClass {
    public static final String EAR_NAME = SCITest_Data.EAR_NAME;
    public static final String WAR_NAME = SCITest_Data.WAR_NAME_ABSOLUTE_NO_OTHERS;
