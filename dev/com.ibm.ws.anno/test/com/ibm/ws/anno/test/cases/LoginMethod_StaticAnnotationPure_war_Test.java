...
public class LoginMethod_StaticAnnotationPure_war_Test extends AnnotationTest_BaseClass {
    public static final String EAR_NAME = LoginMethod_ear_Data.EAR_NAME;
    public static final String WAR_NAME = LoginMethod_ear_Data.WAR_NAME_STATIC_ANNOTATION_PURE;
    ...
    @Test
    public void testLoginMethod_StaticAnnotationPure_war() throws Exception {
