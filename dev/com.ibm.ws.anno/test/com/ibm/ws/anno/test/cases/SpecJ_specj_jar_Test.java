...
import com.ibm.ws.anno.test.data.SpecJ_specj_jar_Data;

public class SpecJ_specj_jar_Test extends AnnotationTest_BaseClass {

    @Override
    public ClassSource_Specification_Direct_EJB createClassSourceSpecification() {
        return SpecJ_specj_jar_Data.createClassSourceSpecification(getClassSourceFactory(),
                                                                   getProjectPath(),
                                                                   getDataPath());
    }
    ...
    public static final String LOG_NAME = SpecJ_specj_jar_Data.EJBJAR_NAME + ".log";
    ...
    public void setUp() throws Exception {
        ...
        setDataPath(SpecJ_specj_jar_Data.EAR_NAME);
    }
    ...
    public String getTargetName() {
        return SpecJ_specj_jar_Data.EJBJAR_NAME;
    }
