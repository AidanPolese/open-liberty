...
public class SecFVT_Servlet30_DynPure_war_Test extends AnnotationTest_BaseClass {
    ...
    public ClassSource_Specification_Direct_WAR createClassSourceSpecification() {
        return SecFVT_Servlet30_Common_war_Data.createClassSourceSpecification(getClassSourceFactory(),
                                                                               getProjectPath(),
                                                                               getDataPath(),
                                                                               SecFVT_Servlet30_Common_war_Data.WAR_DYNPURE_NAME);
    }

    //

    public static final String LOG_NAME = SecFVT_Servlet30_Common_war_Data.WAR_DYNPURE_NAME + ".log";
    ...
    public String getTargetName() {
        return SecFVT_Servlet30_Common_war_Data.WAR_DYNPURE_NAME;
    }
