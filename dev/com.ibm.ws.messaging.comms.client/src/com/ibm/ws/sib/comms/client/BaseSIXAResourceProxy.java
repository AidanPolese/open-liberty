/*
 * @start_prolog@
 * Version: @(#) 1.22 SIB/ws/code/sib.comms.client.impl/src/com/ibm/ws/sib/comms/client/BaseSIXAResourceProxy.java, SIB.comms, WASX.SIB, uu1215.01 10/05/27 09:18:29 [4/12/12 22:14:05]
 * ============================================================================
 ...
 * --------------- ------ -------- --------------------------------------------
 * Creation        050922 prestona Original
 ...
 * D373006.2       070115 mattheg  1pc Optimisation
 ...
 * D399147.4       070726 mleming  Replace XAER_RMERR with XAER_RMFAIL in javadoc
 * PM11871         100519 slaterpa Invalidate conversation on exception
 * ============================================================================
 */
