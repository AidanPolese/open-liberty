/*
 * @start_prolog@
 * Version: @(#) 1.8 SIB/ws/code/sib.comms.client.impl/src/com/ibm/ws/sib/comms/client/SuspendableXAResource.java, SIB.comms, WASX.SIB, uu1215.01 10/07/21 06:08:08 [4/12/12 22:14:21]
 * ============================================================================
 ...
 * D417616         070130 mattheg  Clean up inflight transactions on connection closure (again!)
 * D434395         070424 prestona FINBUGS: fix findbug warnings in sib.comms.client.impl
 * D446175         070623 prestona Fix memory leak of SuspendableXAResources.
 * D476885         071026 mleming  Call removeInflightSIXAResource in finally block
 * D659467         100721 venugopv Remove inflightSIXAResources related code & rollbackInflightWork()
 * ============================================================================
 */
