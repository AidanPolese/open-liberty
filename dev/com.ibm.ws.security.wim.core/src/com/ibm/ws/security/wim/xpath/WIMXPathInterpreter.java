 ...
 * -------- --------   -----  -------------------------------------------
 *09/21/11 prashantb PM45289 VMM PRODUCES DIFFERENT RESULTS FOR SEMANTICALLY IDENTICAL SEARCH EXPRESSIONS
 *05/02/12 speddapa  PM62313 LOGIN FAILED WITH MORE THAN ONE SINGLE OR DOUBLE QUOTES IN USER
 *03/14/13 ankit_jain 123443 WIMXPathInterpreter init call logs the trace after initializing the LookaheadSuccess inner class
 */
 ...
 */         return repos;
        ...
        if (!inRepos && !inLA) {
            throw new AttributeNotSupportedException(
                            WIMMessageKey.ATTRIBUTE_NOT_SUPPORTED, WIMMessageKey.ATTRIBUTE_NOT_SUPPORTED);
        }
/*
 * if (trcLogger.isLoggable(Level.FINER)) {
 * trcLogger.exiting(CLASSNAME, METHODNAME, "Property " + propName
 ...
 */     return la;
    ...
    private String getPropertyLocation(XPathNode xnode)
                    throws AttributeNotSupportedException {
        Iterator<PropertyNode> iter = xnode
                        .getPropertyNodes(new HashMap<Integer, PropertyNode>());
        if (iter.hasNext()) {
 ...
 */ }
     ...
     */
    final public XPathNode parse(MetadataMapper aMetaDataMapper)
                    throws ParseException, AttributeNotSupportedException {
     ...
     */
    final public void wimexpr() throws ParseException,
                    AttributeNotSupportedException {
    ...
    final public void predefinedPredicate() throws ParseException,
                    AttributeNotSupportedException {
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case 7:
                entityTypeExpr();
    ...
    final public void predefinedLocPredicate() throws ParseException,
                    AttributeNotSupportedException {
        jj_consume_token(4);
        predefinedPredicate();
        jj_consume_token(5);
    ...
    final public void internalPredicate() throws ParseException,
                    AttributeNotSupportedException {
        jj_consume_token(4);
        predicateExpr();
        jj_consume_token(5);
 ...
 */
    ...
    final public XPathNode simpleSelectionExpr() throws ParseException,
                    AttributeNotSupportedException {
        XPathNode s1 = null;
        XPathNode s2 = null;
        s1 = andExpr();
    ...
    final public XPathNode orExpr() throws ParseException,
                    AttributeNotSupportedException {
    ...
    final public XPathNode andExpr() throws ParseException,
                    AttributeNotSupportedException {
                    ...
                    if (checkLocation) {
                        ...
                        switch (nodeType) {
                            ...
                            case XPathNode.NODE_LOGICAL:
                                parenNode
                                                .setPropertyLocation(((LogicalNode) bracketedSimpleSel)
                                                                .isPropertyInRepository());
                                break;
                            case XPathNode.NODE_PROPERTY:
                                parenNode
                                                .setPropertyLocation(((PropertyNode) bracketedSimpleSel)
                                                                .isPropertyInRepository());
                                break;
                            case XPathNode.NODE_PARENTHESIS:
                                parenNode
                                                .setPropertyLocation(((ParenthesisNode) bracketedSimpleSel)
                                                                .isPropertyInRepository());
                                break;
                            default:
                                break;
    ...
    final public XPathNode relationalExpr() throws ParseException,
                    AttributeNotSupportedException {
        String s;
        String value;
        Token tOp;
