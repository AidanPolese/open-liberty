 ...
 * ---------------  ------ -------- -------------------------------------------------
 * 222183.4         160804 cwilkin  Extend core spi exceptions to include reasonCodes/inserts
...
public class SIMPConnectionLostException extends SIConnectionLostException
{
  /** The serial version UID, for version to version compatability */
  private static final long serialVersionUID = -701993492189378045L;

  /**
   * @param msg
   */
  public SIMPConnectionLostException(String msg)
  {
    super(msg);
  }
   ...
   * @param t
   */
  public SIMPConnectionLostException(String msg, Throwable t)
  {
    super(msg, t);
  }
