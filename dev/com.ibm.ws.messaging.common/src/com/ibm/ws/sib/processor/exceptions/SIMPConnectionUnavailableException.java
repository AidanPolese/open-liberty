...
public class SIMPConnectionUnavailableException
  extends SIConnectionUnavailableException
{
  /** The serial version UID, for version to version compatability */
  private static final long serialVersionUID = 5837388886313235379L;

  /**
   * @param msg
   */
  public SIMPConnectionUnavailableException(String msg)
  {
    super(msg);
  }
   ...
   * @param t
   */
  public SIMPConnectionUnavailableException(String msg, Throwable t)
  {
    super(msg, t);
  }
