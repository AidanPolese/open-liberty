...
public class SIMPRollbackException extends SIRollbackException
{
  /** The serial version UID, for version to version compatability */
  private static final long serialVersionUID = -3634237022879962598L;

  /**
   * @param msg
   */
  public SIMPRollbackException(String msg)
  {
    super(msg);
  }
   ...
   * @param t
   */
  public SIMPRollbackException(String msg, Throwable t)
  {
    super(msg, t);
  }
