...
public class SIMPDiscriminatorSyntaxException
  extends SIDiscriminatorSyntaxException
{
  /** The serial version UID, for version to version compatability */
  private static final long serialVersionUID = -5076123028335996498L;

  /**
   * @param msg
   */
  public SIMPDiscriminatorSyntaxException(String msg)
  {
    super(msg);
  }
