 ...
 * f168810.4       030611 schmittm Change admin interfaces to .1 level - see f168810
 * d170639         030626 mattheg  Make NLS work and add FFDC probe ID's
 * f171046         030703 mattheg  Improve server side logging and exception handling
 * f169897.2       030708 mattheg  Convert to Core API 0.6
 * f171400         030714 mattheg  Implement Core API 0.6
 * f172297         030722 mattheg  Final Core API 0.6 changes
 * f172397         030728 Niall    Implement ME-to-ME support
 * F171893         030730 prestona Add support for BrowserSession
 * d173280         030801 mattheg  Add flush() for Asynch Consumers
 * f173559         030802 mattheg  CommsString modifications and invalid flag checking
 * f173660         030808 schmittm CommsString modifications for cloneConnection
 * F174327         030814 Niall    ME - ME Connection Support stage 2
 * f174317         030829 mattheg  Add local transaction support
 * d172528         030908 mattheg  Use message priorities correctly
 * f174318         030911 mattheg  Fault tolerance
 * d175811         030919 mattheg  Add FFDC in StaticCATHelper
 * f176954         030918 mattheg  Handshaking probes
 ...
 * f178690         031003 mattheg  Remove need for initial line turnaround on createUniqueId
 * f179464         031010 mattheg  Add meTerminated handling on the server
 * d180309         031020 mattheg  Fix browser session exception handling
 * f181195         031029 mattheg  Client XA support
 * f181927         031111 mattheg  Client XA support continuation
 * f179629.2.3     031124 Niall    Destination Configuration support
 * f179519.1       031209 mattheg  Add SIDestinationWrongTypeException handling
 * f181801.9       031217 vaughton Switch trace groups to utils
 * d184027         040106 mattheg  Move location of some server methods
 * f172521.2       040113 Niall    Support MFP Schema Propogation
 * d187056         040115 mattheg  Readahead durable sub hang
 ...
 * f192215         040226 mattheg  Proxy queue enhancements
 * f192654         040301 mattheg  Allow inline callbacks through config parameter
 * d187252         040302 mattheg  Ensure session destination information is only returned if it changes
 * d193063         040310 mattheg  Ensure that we inform the other ME when we are about to close
 * f192759.2       040311 mattheg  M7 Core SPI changes
 * d194950         040318 mattheg  M7 Fixes
 * f196076         040326 mattheg  Multicast support -- phase 2
 * f195445.8       040407 mattheg  Updating the message prefixes
 * f192829         040407 mattheg  Client tuning parameters
 * f195758.2       040415 mattheg  Core SPI 7.5 updates
 * f199593         040422 mattheg  Complete M7.5 Core SPI updates
 * d200152         040426 mattheg  Correct FFDC probes for bifurcated sessions
 * f200337         040427 mattheg  Message order context implementation
 * f184312.4.2     040503 mattheg  sendToExceptionDestination method
 * F202571         040507 mattheg  DirectConnection method support
 * D203921         040518 mattheg  DestinationContext sent with destination configuration
 * D209401         040614 mattheg  Comms service utility
 * F195720.3       040616 prestona WAS Request Metrics in Jetstream
 * f183052.2       040629 mayur    Add constant for MQLinkManager
 * d214170         040705 mayur    Correct value of MQLinkManager constant
 * D214620         040709 mattheg  Addition of read ahead tuning paramters
 * D217339         040719 mattheg  Update message prefix -- again
 * D217372         040719 mattheg  Comms constants re-organisation
 * F201972.2       040727 mattheg  Core SPI Exceptions rework (not change flagged)
 * D221834         040805 mattheg  Remove un-needed exception constants
 * D219803         040810 mattheg  Comms package renames
 * D220088         040813 mattheg  Expire proxy queue methods
 * D218324         040818 mattheg  RH Queue spins when stopped and receiveWithWait
 ...
 * D237041         041005 mattheg  Modify CF_MAX_VALID
 * D225856         041006 mattheg  Update FFDC class names
 * D241156         041026 mattheg  OrderingContext update
 * D249096         050129 prestona Fix proxy queue synchronization
 * F247845         050131 mattheg  Multicast enablement
 * F247975         050203 prestona Add constants for handshake capabilities.
 * F206161.5       050217 prestona Events for system management products
 * D256703         050221 mattheg  FFDC when object store is full
 * D255694         040222 mattheg  Add destination address flag
 * D257768         050301 mattheg  Ensure global trans are cleaned up on connection failure
 * LIDB3684.11.1.3 050329 mattheg  checkMessagingRequired() Core SPI change
 * D264771         050412 mattheg  FFDC when unlockAll() fails on de-reg async
 * D271523         050503 mattheg  Make async callbacks inlined by default
 * D280276         050602 prestona NPE with large messages
 * D295765         050905 prestona ME-ME should close conversation when invalid segment received.
 * D297060         050821 prestona IdToTransactionTable memory leak
 * SIB0009.comms.1 050830 mattheg  Support for invokeCommand() method
 ...
 * D335337         060104 mattheg  Send heartbeat timeout on handshake
 * D344786         060206 mattheg  Re-work ME-ME close locking
 * D347591         060217 mattheg  Add support for exchanged starts
 * D350111.1       060302 mattheg  Support FAP changes in light of 350111
 * D351339.comms   060302 mattheg  Implement ignoreInitialIndoubts createConsumerSession() method
 * D360111         060410 mattheg  Close window for MFP illegal state exception
 * D361638         060411 mattheg  Memory leak tracking connections
 * D354485.2       060418 mattheg  Externalise MQUtil methods
 * D365952         060523 mattheg  Handling of SIMessageNotLockedException
 * D377093.1       060712 mattheg  Implement invokeCommand(with TX) - FAP 6
 ...
 * D395634         061005 mattheg  Add Server Diag module class name
 * D400132         061025 mattheg  FFDC's for async events
 ...
 * D417119         070130 mattheg  Fix incorrectly named properties
 * SIB0117a.2      070322 mleming  Add trace group for MQLink FAP flows
 ...
 * SIB0100.wmq.3   070814 mleming  Add FIELDID_WMQRA_CONNECT
 * SIB0113.comms.1 070920 vaughton Core SPI changes
 * SIB0137.comms.2 070925 vaughton Add DestinationAvailable constant
 ...
 * 534889          080711 vaughton Don't FFDC on connection failure
 * 568951          081215 mleming  Code review adjustments to PK73713
 * PK86574         290509 pbroad   Allow for strict message redelivery ordering
 * 623498          091027 slaterpa Ensure we always post to start semaphore after wait
 * F002074         091022 mleming  MEP support FIS
 * PM12356         100510 sherring Restrict access to LinkedList queue to prevent dirty reads / writes
 * 656028          100610 Venu     Upgrading JFAP level to 13.
 * PM23837         101006 pbroad   Add probeid
 * PM34003         110329 slaterpa Add probeid for CATAsynchReadAheadReader.consumeMessages
