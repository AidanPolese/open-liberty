...
/**
 * ControlHighestGeneratedTick extends the general ControlMessage interface and provides
 * get/set methods for the fields specific to a Control Highest Generated Tick Message.
 *
 */
public interface ControlHighestGeneratedTick extends ControlMessage {
  ...
  /**
   * Set the Tick value for this request.
   *
