 ...
 * 92933           07/02/13 Venu     Removal of targetTranport
 * 94187           19/02/13 chetbhat Exception when jmsServer is removed when MDB is still running
 * 94126           20/02/13 Sanjay   Changes to rename the connectionName
 * 94127           20/02/13 Venu     Treating as error for REDIRECT from tWAS
 * 95741           13/03/13 Kavitha  Throw actual exception on connection failure
 * 96380           15/03/13 Sanjay   Throw SIResourceException instead of NPE
 * ============================================================================
 */
