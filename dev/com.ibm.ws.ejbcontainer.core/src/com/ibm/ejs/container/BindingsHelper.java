...
public class BindingsHelper
{
    ...
    public ArrayList<String> generateBindings(String interfaceName,
                                              String specificBindingName,
                                              boolean
                                              generateDisambiguatedSimpleBindingNames)
                    throws NameAlreadyBoundException // d457053.1
    {
    ...
    private void addAmbiguousSimpleBindingName(String simpleBindingName)
    {
        ...
        Reference ambiguousReference = AmbiguousEJBRefReferenceFactory.
                        createAmbiguousReference(simpleBindingName,
    ...
    private void addAmbiguousShortDefaultBindingName(String shortBindingName)
    {
        ...
        Reference ambiguousReference = AmbiguousEJBRefReferenceFactory.
                        createAmbiguousReference(shortBindingName, beans);
