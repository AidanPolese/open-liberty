...
public class AsyncMethodWrapper extends EJSWrapperBase implements Runnable
{
     ...
     */
    public AsyncMethodWrapper(EJSWrapperBase theCallingWrapper,
    ...
    public void run()
    {
        ...
        try
        {
            try
            {
                ...
                if (methodInfo.getAroundInterceptorProxies() == null) // F743-24429
                {
                    try {
    ...
    private boolean isApplicationException(Throwable ex, EJBMethodInfoImpl methodInfo)
    {
        ...
        if (ex instanceof Exception &&
            ...
            !(ex instanceof RuntimeException))) // d660332
        {
