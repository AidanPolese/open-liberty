...
public class RuntimeFactory {
    ...
    private final CDIRuntimeImpl services;
     ...
     * @param services
     */
    public RuntimeFactory(CDIRuntimeImpl services) {
     ...
     * @throws CDIException
     */
    Application newApplication(ApplicationInfo appInfo) throws CDIException {
    ...
    Application removeApplication(ApplicationInfo appInfo) {
     ...
     * @return
     */
    public CDIRuntimeImpl getServices() {
        return services;
    }
