 ...
 */
public class ConsoleWrapperTest extends TestRepository {

    /**
     * Test method for {@link com.ibm.ws.config.utility.utils.ConsoleWrapper#isInputStreamAvailable()}.
     */
    @Test
    public void isConsoleAvailable_false() throws Exception {
    ...
    /**
     * Test method for {@link com.ibm.ws.config.utility.utils.ConsoleWrapper#readMaskedText(java.lang.String)}.
     */
    @Test
    public void readMaskedText_noConsole() throws Exception {
        Assume.assumeTrue(testRepositoryConnection());
