...
public class JPA21Runtime extends JPA20Runtime implements JPARuntime {
    ...
    public EntityManagerFactory createJPAEMFactory(JPAPuId puId, J2EEName j2eeName, EntityManagerFactory emf) {
        return new JPAEMFactoryV21(puId, j2eeName, emf);
    }
    ...
    public JPATxEntityManager createJPATxEntityManager(JPAPuId puRefId, JPAPUnitInfo puInfo, J2EEName j2eeName, String refName, Map<?, ?> properties,
        ...
        return new JPATxEntityManagerV21(puRefId, puInfo, j2eeName, refName, properties, isUnsynchronized, jpaComponent);
    }
    ...
    public JPAExEntityManager createJPAExEntityManager(JPAPuId puRefId, JPAPUnitInfo puInfo, J2EEName j2eeName, String refName, Map<?, ?> properties,
                                                       boolean isUnsynchronized, AbstractJPAComponent jpaComponent) {
        return new JPAExEntityManagerV21(puRefId, puInfo, j2eeName, refName, properties, isUnsynchronized, jpaComponent);
    }

    @Override
    public JPAExEmInvocation createExEmInvocation(UOWCoordinator uowCoord, EntityManager em, boolean txIsUnsynchronized) {
        return new JPAExEmInvocationV21(uowCoord, em, txIsUnsynchronized);
    }
...
//    private boolean checkServiceRegistryFor21DefaultDataSource() {
//        final String resourceFactoryClass = "com.ibm.ws.resource.ResourceFactory";
//        final String pattern = "(&(id=DefaultDataSource)(creates.objectClass=javax.sql.DataSource))";
//        boolean returnVal = false;
//
//        try {
//            ServiceReference<?>[] srArr = cCtx.getBundleContext().getServiceReferences(resourceFactoryClass, pattern);
...
//            Tr.debug(tc, "JPA21Runtime: Default JTA DataSource available: " + returnVal);
//        }
//        return returnVal;
//    }
}
