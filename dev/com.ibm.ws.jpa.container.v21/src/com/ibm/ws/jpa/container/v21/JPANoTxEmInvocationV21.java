...
public class JPANoTxEmInvocationV21 extends JPANoTxEmInvocation {
    protected JPANoTxEmInvocationV21(UOWCoordinator uowCoord, EntityManager em, JPAEntityManager jpaEm, boolean txIsUnsynchronized) {
