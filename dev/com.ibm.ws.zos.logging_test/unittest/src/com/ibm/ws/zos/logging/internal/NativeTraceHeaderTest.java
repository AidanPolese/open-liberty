...
public class NativeTraceHeaderTest {
    ...
    public void test_toStringProblemStateKey8() {
        ...
        NativeTraceHeader nativeTraceHeader = new NativeTraceHeader(TRACE_POINT, TCB_ADDRESS, NATIVE_TRACE_KEY_8,
                                                                    NATIVE_TRACE_PROBLEM_STATE, TRACE_CREATE_TIME);
    ...
    public void test_toStringSupervisorStateKey2() {
        ...
        NativeTraceHeader nativeTraceHeader = new NativeTraceHeader(TRACE_POINT, TCB_ADDRESS, NATIVE_TRACE_KEY_2,
                                                                    NATIVE_TRACE_SUPERVISOR_STATE, TRACE_CREATE_TIME);
        String traceHeader = nativeTraceHeader.toString();
        System.out.println(traceHeader);
