...
public class EmbeddedServerAddProductExtensionTest {
    ...
    static String serverName = "com.ibm.wsspi.kernel.embeddable.add.product.extension.fat";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        ls = LibertyServerFactory.getLibertyServer("com.ibm.wsspi.kernel.embeddable.add.product.extension.fat");
