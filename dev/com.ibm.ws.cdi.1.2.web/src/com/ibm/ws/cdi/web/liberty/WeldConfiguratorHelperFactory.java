    ...
    static class WeldConfigHelper implements ServletConfiguratorHelper {
        ...
        public void configureFromWebApp(WebApp webApp) throws UnableToAdaptException {
            ...
            if (filterConfig != null) {
                ...
                filterConfig.setFilterClassName(ConversationFilter.class.getName());
                filterConfig.setFilterClass(ConversationFilter.class);
                filterConfig.setFilterClassLoader(ConversationFilter.class.getClassLoader());
            }
        }
