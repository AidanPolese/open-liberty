                ...
                extends DefaultHandler
{
     ...
     **/
    public static JaxbPersistence unmarshal(JPAPXml pxml)
                    throws PersistenceException //d86387
    {
        ...
        } catch (Throwable ex)
        {
            ...
            else
            {
                ...
                pex = new PersistenceException("CWWJP0018E: Incorrect syntax " +
                                               ...
                                               " module " + modName +
                                               ". The following associated error occurred:",
                                root); // 86387
            }
                    ...
                    throws SAXException
    {
        if (ivHandler == null)
        {
            ...
            try
            {
                JAXBContext jaxbContext = JAXBContext.newInstance(ivPersistence.ivJAXBPackageName, svClassLoader);
