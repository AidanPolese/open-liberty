...
import com.ibm.ws.jpa.pxml21.Persistence.PersistenceUnit;
import com.ibm.ws.jpa.pxml21.PersistenceUnitCachingType;
import com.ibm.ws.jpa.pxml21.PersistenceUnitValidationModeType;

public class JaxbPUnit21 extends JaxbPUnit {
     private static final String CLASS_NAME = JaxbPUnit21.class.getName();
     private static final TraceComponent tc = Tr.register(JaxbPUnit21.class, JPA_TRACE_GROUP, JPA_RESOURCE_BUNDLE_NAME);

     private PersistenceUnit ivPUnit;

     /**
      * Constructs a JaxbPUnit21 instance with the JAXB PersistenceUnit instance for which the
      * created instance will provide an abstraction.
      **/
     JaxbPUnit21(PersistenceUnit pUnit) {
          if (pUnit == null) {
      ...
      * <p>
      * 
      * Note that the default value defined in the 2.1 persistence xsd is 'true', however, that is
     ...
     public boolean isExcludeUnlistedClasses() {
          ...
          // The version 2.1 persistence.xsd spelled out the default for
     ...
     public SharedCacheMode getSharedCacheMode() {
          ...
          // in JAXB (com.ibm.ws.jpa.pxml21.PersistenceUnitCachingType)
     ...
     public ValidationMode getValidationMode() {
          ...
          // in JAXB (com.ibm.ws.jpa.pxml21.PersistenceUnitValidationModeType)
