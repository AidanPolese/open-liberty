...
public class JPAScopeInfo
{
    ...
    void processPersistenceUnit(JPAPXml pxml, JPAApplInfo applInfo)
    {
        ...
        String pxmlInfoKey = scope == JPAPuScope.EAR_Scope ? pxml.getArchiveName()
                        : pxmlRootURL.toString();
    ...
    */
    ...
    JPAPUnitInfo getPuInfo(String puName)
    {
        ...
        if (isTraceOn && tc.isEntryEnabled())
            Tr.exit(tc, "getPuInfo : " + (rtnVal != null ? rtnVal.getPersistenceUnitName()
                            : "PU not found."));
        return rtnVal;
    }
    ...
    {
        sbuf.append("\nScopeInfo: ScopeName = ").append(scopeName)
