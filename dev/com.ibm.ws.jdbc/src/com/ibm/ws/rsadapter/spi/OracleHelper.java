...
public class OracleHelper extends DatabaseHelper {
    ...
    public Map<String, Object> cacheVendorConnectionProps(Connection sqlConn) throws SQLException {
        try {
            ...
            if (c == null)
                OracleConnection.set(c = PrivHelper.loadClass(mcf.dsConfig.get().classloader, oracle_jdbc_OracleConnection));
    ...
    public void doStatementCleanup(PreparedStatement stmt) throws SQLException {
        ...
        try {
            ...
            if (m == null) {
                Class<?> c = PrivHelper.loadClass(mcf.dsConfig.get().classloader, oracle_jdbc_OraclePreparedStatement);
    ...
    public String getXAExceptionContents(XAException xae) {
        ...
        try {
            Class<?> c = PrivHelper.loadClass(mcf.dsConfig.get().classloader, "oracle.jdbc.xa.OracleXAException");
    ...
    private void setTrace(boolean b) {
        try {
            Class<?> c = PrivHelper.loadClass(mcf.dsConfig.get().classloader, oracle_jdbc_driver_OracleLog);
