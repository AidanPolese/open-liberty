...
/**
* A reusable key for DB2 SQLJ PreparedStatement caching.
*/
public class DB2SQLJPSCacheKey extends StatementCacheKey
{
    ...
    */
    public DB2SQLJPSCacheKey(String theSQL, int theType, int theConcurrency,
           ...
           String cacheKeySuffix)
    {
        ...
        statementType = DB2_SQLJ_PREPARED_STATEMENT;
    ...
    */
    ...
    {
        return "DB2 SQLJ PSTMT: " + sql + ' ' + type + ' ' + concurrency + ' ' +
