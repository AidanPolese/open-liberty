 ...
 * made against the ProducerSession interface.
 * 
 * Filtering can be done against 
 * com.ibm.ws.sib.processor.impl.trace.CoreSPIProducerSession
 *
 */
public class CoreSPIProducerSession
{

  //trace for messages
  public static final TraceComponent tc =
    SibTr.register(
      CoreSPIProducerSession.class,
