 ...
 * made against the LockedMessageEnumeration interface.
 * 
 * Filtering can be done against 
 * com.ibm.ws.sib.processor.impl.trace.CoreSPILockedMessageEnumeration
 *
 */
public class CoreSPILockedMessageEnumeration
{

  //trace for messages
  public static final TraceComponent tc =
    SibTr.register(
      CoreSPILockedMessageEnumeration.class,
