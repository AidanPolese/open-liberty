...
@Component(configurationPid = "com.ibm.ws.javaee.dd.commonbnd.DataSource",
     configurationPolicy = ConfigurationPolicy.REQUIRE,
     immediate=true,
     property = "service.vendor = IBM")
public class DataSourceComponentImpl implements com.ibm.ws.javaee.dd.commonbnd.DataSource {
private Map<String,Object> configAdminProperties;
private com.ibm.ws.javaee.dd.commonbnd.DataSource delegate;
     ...
     public void setDelegate(com.ibm.ws.javaee.dd.commonbnd.DataSource delegate) {
