...
@Component(configurationPid = "com.ibm.ws.javaee.dd.ejbext.Session",
     configurationPolicy = ConfigurationPolicy.REQUIRE,
     immediate=true,
     property = "service.vendor = IBM")
public class SessionComponentImpl extends com.ibm.ws.javaee.ddmodel.ejbext.EnterpriseBeanType implements com.ibm.ws.javaee.dd.ejbext.Session {
private Map<String,Object> configAdminProperties;
private com.ibm.ws.javaee.dd.ejbext.Session delegate;

     @Reference(cardinality = ReferenceCardinality.OPTIONAL, policy = ReferencePolicy.DYNAMIC, name = "time-out", target = "(id=unbound)")
     protected volatile com.ibm.ws.javaee.dd.ejbext.TimeOut time_out;
     ...
     public com.ibm.ws.javaee.dd.ejbext.TimeOut getTimeOut() {
          if (delegate == null) {
               return time_out == null ? null : time_out;
          } else {
               return time_out == null ? delegate.getTimeOut() : time_out;
          }
     }
     ...
     public void setDelegate(com.ibm.ws.javaee.dd.ejbext.Session delegate) {
