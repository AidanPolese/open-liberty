...
public class ClientRefBindingsGroupType extends com.ibm.ws.javaee.ddmodel.commonbnd.RefBindingsGroupType implements com.ibm.ws.javaee.dd.clientbnd.ClientRefBindingsGroup {
    public ClientRefBindingsGroupType() {
        this(false);
    }

    public ClientRefBindingsGroupType(boolean xmi) {
        super(xmi);
    }
    ...
    public boolean handleChild(DDParser parser, String localName) throws DDParser.ParseException {
        if ((xmi ? "ejbRefs" : "ejb-ref").equals(localName)) {
        ...
        if ((xmi ? "resourceRefs" : "resource-ref").equals(localName)) {
        ...
        if ((xmi ? "messageDestinationRefs" : "message-destination-ref").equals(localName)) {
    ...
    public void describe(com.ibm.ws.javaee.ddmodel.DDParser.Diagnostics diag) {
        diag.describeIfSet(xmi ? "ejbRefs" : "ejb-ref", ejb_ref);
        diag.describeIfSet(xmi ? "resourceRefs" : "resource-ref", resource_ref);
        diag.describeIfSet(xmi ? "resourceEnvRefBindings" : "resource-env-ref", resource_env_ref);
        diag.describeIfSet(xmi ? "messageDestinationRefs" : "message-destination-ref", message_destination_ref);
