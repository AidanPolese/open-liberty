...
@Component(configurationPid = "com.ibm.ws.javaee.dd.appbnd.ApplicationBnd",
     configurationPolicy = ConfigurationPolicy.REQUIRE,
     immediate=true,
     property = "service.vendor = IBM")
public class ApplicationBndComponentImpl extends com.ibm.ws.javaee.ddmodel.commonbnd.RefBindingsGroupType implements com.ibm.ws.javaee.dd.appbnd.ApplicationBnd {
private Map<String,Object> configAdminProperties;
private com.ibm.ws.javaee.dd.appbnd.ApplicationBnd delegate;

     @Reference(cardinality = ReferenceCardinality.MULTIPLE, policy = ReferencePolicy.DYNAMIC, name = "security-role", target = "(id=unbound)")
     protected void setSecurity_role(com.ibm.ws.javaee.dd.appbnd.SecurityRole value) {
          this.security_role.add(value);
     }

     protected void unsetSecurity_role(com.ibm.ws.javaee.dd.appbnd.SecurityRole value) {
          this.security_role.remove(value);
     }

     protected volatile List<com.ibm.ws.javaee.dd.appbnd.SecurityRole> security_role = new ArrayList<com.ibm.ws.javaee.dd.appbnd.SecurityRole>();
     ...
     public java.util.List<com.ibm.ws.javaee.dd.appbnd.SecurityRole> getSecurityRoles() {
          java.util.List<com.ibm.ws.javaee.dd.appbnd.SecurityRole> returnValue = delegate == null ? new ArrayList<com.ibm.ws.javaee.dd.appbnd.SecurityRole>() : new ArrayList<com.ibm.ws.javaee.dd.appbnd.SecurityRole>(delegate.getSecurityRoles());
     ...
     public java.util.List<com.ibm.ws.javaee.dd.appbnd.Profile> getProfiles() {
          // Not Used In Liberty -- returning default value or app configuration
          java.util.List<com.ibm.ws.javaee.dd.appbnd.Profile> returnValue = delegate == null ? new ArrayList<com.ibm.ws.javaee.dd.appbnd.Profile>() : new ArrayList<com.ibm.ws.javaee.dd.appbnd.Profile>(delegate.getProfiles());
          return returnValue;
     }
...
// End of DeploymentDescriptor Methods -- Not used in Liberty
     ...
     public void setDelegate(com.ibm.ws.javaee.dd.appbnd.ApplicationBnd delegate) {
