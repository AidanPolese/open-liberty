...
public class LauncherOptions_pt_BR extends java.util.ListResourceBundle
{
   ...
   private final static Object[][] resources= {
      ...
      { "briefUsage", "Uso: java [JVM options] -javaagent:bin/tools/ws-javaagent.jar \\        \n\t-jar bin/tools/ws-server.jar serverName [actions] [options]  " },
      ...
      { "option-desc.archive", "\tEspecifique o destino do archive a ser gerado pela a\u00e7\u00e3o do    \n\tpacote ou de dump. O destino pode ser especificado como um caminho absoluto ou como \n\tum caminho relativo. Se essa op\u00e7\u00e3o for omitida, o archive ser\u00e1\n\tcriado no diret\u00f3rio de sa\u00edda do servidor. A extens\u00e3o do nome do arquivo de      \n\tdestino pode influenciar o formato do archive gerado.       \n \tO formato de archive padr\u00e3o da a\u00e7\u00e3o do pacote \u00e9 \"pax\" no z/OS   \n\te \"zip\" em todas as outras plataformas.                                    \n\tO formato de archive \"jar\" produzir\u00e1 um jar autoextrator semelhante ao   \n\tarchive do instalador original.                                      \n\tO formato de archive \"jar\" combinado com \"runnable\" na op\u00e7\u00e3o --include\n\tproduz um arquivo jar execut\u00e1vel que pode executar o servidor Liberty a partir    \n\tdo arquivo jar usando java -jar." },
      { "option-desc.clean", "\tLimpar todas as informa\u00e7\u00f5es em cache relacionadas a esta inst\u00e2ncia do servidor." },
      { "option-desc.include", "\tUma lista de valores delimitada por v\u00edrgula. Os valores v\u00e1lidos variam, dependendo da\n \ta\u00e7\u00e3o." },
      ...
      { "scriptUsage", "Uso: {0} action serverName [options]" },
      { "use.actions", "A\u00e7\u00f5es:" },
