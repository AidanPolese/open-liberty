...
/**
 * Factory for creating the pass-thru test channel.
 */
@SuppressWarnings("unused")
public class PassThruFactory implements ChannelFactory {
    ...
    public synchronized Channel findOrCreateChannel(ChannelData channelData) throws ChannelException {
        ...
        if (null == rc) {
            rc = new PassThruChannel(channelData, this);
