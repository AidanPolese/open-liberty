...
import com.ibm.ws.security.jsr375.JSR375Constants;
...
@Component(service = WebSphereCDIExtension.class,
           ...
           immediate = true)
public class JSR375CDIExtension<T> implements Extension, WebSphereCDIExtension {

    private static final TraceComponent tc = Tr.register(JSR375CDIExtension.class);
...
//            beansToAdd.add(bean);
    ...
    private Properties parseLoginToContinue(Annotation annotation, Class<? extends Annotation> annotationType) throws Exception {
        ...
        props.put(JSR375Constants.LOGIN_TO_CONTINUE_LOGINPAGE, getAnnotatedString(ltcAnnotation, ltcAnnotationType, JSR375Constants.LOGIN_TO_CONTINUE_LOGINPAGE));
        props.put(JSR375Constants.LOGIN_TO_CONTINUE_ERRORPAGE, getAnnotatedString(ltcAnnotation, ltcAnnotationType, JSR375Constants.LOGIN_TO_CONTINUE_ERRORPAGE));
        props.put(JSR375Constants.LOGIN_TO_CONTINUE_USEFORWARDTOLOGINEXPRESSION,
                  getAnnotatedString(ltcAnnotation, ltcAnnotationType, JSR375Constants.LOGIN_TO_CONTINUE_USEFORWARDTOLOGINEXPRESSION));
        props.put(JSR375Constants.LOGIN_TO_CONTINUE_USEFORWARDTOLOGIN, getAnnotatedBoolean(ltcAnnotation, ltcAnnotationType, JSR375Constants.LOGIN_TO_CONTINUE_USEFORWARDTOLOGIN));
        return props;
    }
